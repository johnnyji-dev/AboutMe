...
const DATA = {
  ko: {
    ...
    projects: {
      title: "Projects",
      desc: "오픈소스와 개인 프로젝트를 정리했습니다.",
      tab1: "Blockchains",
      tab2: "Fullstack & Other",
      categories: {
        blockchains: [
          {
          ...
          {
            name: "blockchainScPrjs",
            desc: "블록체인 스마트 컨트랙트·스크립트 프로젝트",
            href: "https://github.com/johnnyji-dev/blockchainScPrjs",
            tag: "Smart Contract",
          },
          {
          ...
          },
          {
            ...
            desc: "블록체인 API 서버 (TypeScript)",
            href: "https://github.com/johnnyji-dev/blockchain-api-server",
            tag: "Backend",
          },
          {
            name: "polkadotUnit",
            desc: "Polkadot 관련 유닛·테스트 (TypeScript)",
            href: "https://github.com/johnnyji-dev/polkadotUnit",
            tag: "Testing",
          },
          {
            name: "modudao-web",
            desc: "ModuDAO 웹 (JavaScript)",
            href: "https://github.com/johnnyji-dev/modudao-web",
            tag: "Web",
          },
          {
            name: "blockchain_devOps",
            desc: "블록체인 DevOps",
            href: "https://github.com/johnnyji-dev/blockchain_devOps",
            tag: "DevOps",
          },
        ],
        fullstack: [
          {
            ...
            desc: "풀스택 모노레포 템플릿 (Next.js, FastAPI, Flutter, Terraform, mise)",
            href: "https://github.com/johnnyji-dev/fullstack-starter",
            tag: "Template",
          },
          { name: "react_pwa", desc: "React PWA", href: "https://github.com/johnnyji-dev/react_pwa", tag: "Frontend" },
          {
            name: "CSLangQuestProjects",
            desc: "CS·언어 퀘스트 프로젝트",
            href: "https://github.com/johnnyji-dev/CSLangQuestProjects",
            tag: "Learning",
          },
          { name: "kisa-dapp-basic", desc: "KISA DApp 기초 (TypeScript fork)", href: "https://github.com/johnnyji-dev/kisa-dapp-basic", tag: "DApp" },
          { name: "book-examples", desc: "SSI-Korea 책 예제 (Go, Apache 2.0)", href: "https://github.com/johnnyji-dev/book-examples", tag: "Go" },
        ],
      },
    },
    skills: {
    ...
    contact: {
      ...
      linksTitle: "Links",
      email: "Email",
      emailValue: "your@email.com (update me)",
      linkedinValue: "프로필 URL을 추가해주세요",
      telegramValue: "링크를 추가해주세요",
      noteTitle: "Note",
  ...
  en: {
    ...
    projects: {
      title: "Projects",
      desc: "A curated list of open source and personal projects.",
      tab1: "Blockchains",
      tab2: "Fullstack & Other",
      categories: {
        blockchains: [
          { name: "blockchain-node-guides", desc: "Blockchain node setup & operations guides (Shell)", href: "https://github.com/johnnyji-dev/blockchain-node-guides", tag: "Node / Infra" },
          { name: "blockchainScPrjs", desc: "Smart contracts & scripts collection", href: "https://github.com/johnnyji-dev/blockchainScPrjs", tag: "Smart Contract" },
          { name: "crypto-wallet-core", desc: "Crypto wallet core library", href: "https://github.com/johnnyji-dev/crypto-wallet-core", tag: "Wallet" },
          { name: "blockchain-api-server", desc: "Blockchain API server (TypeScript)", href: "https://github.com/johnnyji-dev/blockchain-api-server", tag: "Backend" },
          { name: "polkadotUnit", desc: "Polkadot-related units & tests (TypeScript)", href: "https://github.com/johnnyji-dev/polkadotUnit", tag: "Testing" },
          { name: "modudao-web", desc: "ModuDAO web app (JavaScript)", href: "https://github.com/johnnyji-dev/modudao-web", tag: "Web" },
          { name: "blockchain_devOps", desc: "Blockchain DevOps notes & automation", href: "https://github.com/johnnyji-dev/blockchain_devOps", tag: "DevOps" },
        ],
        fullstack: [
          { name: "fullstack-starter", desc: "Fullstack monorepo template (Next.js, FastAPI, Flutter, Terraform, mise)", href: "https://github.com/johnnyji-dev/fullstack-starter", tag: "Template" },
          { name: "react_pwa", desc: "React PWA", href: "https://github.com/johnnyji-dev/react_pwa", tag: "Frontend" },
          { name: "CSLangQuestProjects", desc: "CS & programming language quest projects", href: "https://github.com/johnnyji-dev/CSLangQuestProjects", tag: "Learning" },
          { name: "kisa-dapp-basic", desc: "KISA DApp basics (TypeScript fork)", href: "https://github.com/johnnyji-dev/kisa-dapp-basic", tag: "DApp" },
          { name: "book-examples", desc: "Book examples (Go, Apache 2.0)", href: "https://github.com/johnnyji-dev/book-examples", tag: "Go" },
        ],
      },
    },
    skills: {
