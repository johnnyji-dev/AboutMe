...
export const DATA = {
  ko: {
    ...
    about: {
      ...
      interest1: "DeFi·스마트컨트랙트와 활용 가능한 유틸리티 dApp 서비스의 방향성",
      interest2: "크립토 서비스 운영 안정성과 사용자 성향·니즈 파악",
      interest3: "크립토 유틸리티 dApp 구상",
    },
    exp: {
      title: "Experience",
  ...
  en: {
    ...
    about: {
      ...
      interestTitle: "Interests",
      interest1: "DeFi & smart contracts and direction for practical utility dApp services",
      interest2: "Operational stability of crypto services and understanding user behavior and needs",
      interest3: "Conceptualizing crypto utility dApps",
    },
    exp: {
      title: "Experience",
